...
- [ ] 1.11 Add AGPL-3.0: full licence text at the repository root, the copyright header pattern applied to existing sources, and the licence declared in the Gradle build. Do this before the codebase grows, so headers are established rather than retrofitted across hundreds of files.
...
- [ ] 4.10 Implement point-in-time valuation and on-hand as at a given date, excluding movements effective after it.
