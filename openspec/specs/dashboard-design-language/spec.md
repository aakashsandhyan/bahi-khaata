...
The shared visual system every dashboard screen follows — tokens, typography, component classes, money formatting, single accent identity, offline-safe assets. Established by the palletworks-foundation change.
