...
The Dashboard home screen and its aggregate API: KPI tiles, the received → priced → sold funnel, real-signal decision alerts, recent sales, and desktop landing behavior. Established by the palletworks-dashboard change.
