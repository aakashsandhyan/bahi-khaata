# register-sessions Specification

## Purpose
The drawer lifecycle: a register opens with a counted float and an operator, absorbs cash movements and cash sales, and closes against a counted drawer with a pinned over/short.
